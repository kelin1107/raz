...
SUBTOPICS = [
    ...
    ('社会与人文', 'bio', r'\bbiographys?\b|\blifes?\b|\bpresidents?\b|\bscientists?\b|\binventors?\b|\bartists?\b|\bwriters?\b|\bleaders?\b|\bheros?\b|\bfamouss?\b|\bstoriess?\b|\blegends?\b',   '📖 名人传记',
     '传记书讲真实名人（总统/科学家/艺术家/探险家）的一生与成就。一天读，work/help/make 反复出现，孩子理解「一个人能做大事」，并练 name/life/invent 等词。',
     '1) 人物卡：做一本主角的时间线（born→famous→now）。\n2) 故事：讲一段他做的事给大人听。\n3) 画：画这位人物＋他最出名的发明/事迹。', 'no',
     '（建议不做合成图：人物各异难同框，更适合做人物卡，不做生图。）'),
    ('社会与人文', 'family', r'\bmoms?\b|\bdads?\b|\bmummies\b|\bdaddies\b|\bgrandparents?\b|\bgrandmas\b|\bgrandpas\b|\bfamilys?\b|\btwins?\b|\bfriends?\b|\bbrothers?\b|\bsisters?\b|\bparents?\b|\bfaces?\b',   '👪 家庭与朋友',
     '这些书讲家人/朋友/双胞胎：妈妈、爸爸、爷爷奶奶、兄弟姐妹、同伴。一天读，mom/dad/family/friend 反复出现，孩子把「我的圈子」说出来。',
     '1) 家庭树：画一家人的简笔画，标 mom/dad/me。\n2) 朋友卡：画一个好朋友，写他喜欢什么。\n3) 双胞胎：若有兄弟姐妹，比一样/不一样。', 'no',
     '（建议不做合成图：家庭照片感更强，更适合做家庭树，不做生图。）'),
