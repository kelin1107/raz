...
SUBTOPICS = [
    # ---------------- 生命世界 ----------------
    ('生命世界', 'bird', r'\bbird\b|birds|eagle|owl|penguin|\bhens?\b|chicken|duck|goose|robin|parrot|flamingo', '🐦 鸟类',
    ...
    ('生命世界', 'sense', r'sense|senses|eye|nose|tongue|skin|smell|taste|touch|hear|see', '👀 感官',
